...
<body>
    ...
    $pages = array(
        ...
        array('title' => '健檢類別查詢', 'link' => 'item_search.php'), // 健檢類別查詢的連結指向:健檢類別查詢.php 
        array('title' => '尊爵套餐', 'link' => '尊爵套餐.php'), // 尊爵套餐的連結指向:尊爵套餐.php
    );
    ...
    <div class="content">
        ...
        <table class="type1">
            ...
            <tr class="category1">
                ...
                <th class="centered"  class="">檢查意義</th>
                <th class="centered">尊爵Ａ</th>
                <th class="centered">尊爵Ｂ</th>
                <th class="centered">尊爵Ｃ</th>
                <th class="centered">尊爵Ｄ</th>
            </tr>
            </thead>
            ...
            <tr> 
                ...
                <td class="centered">58000</td>
                <td class="centered">62000</td>
                <td class="centered">73000</td>
                <td class="centered">83000</td>
            </tr>
            </tbody>
        </table>
